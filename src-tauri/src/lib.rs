...
fn make_specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new().commands(tauri_specta::collect_commands![
        ...
        commands::settings_harvest::set_settings_harvest,
        commands::settings_harvest::get_settings_harvest,
        commands::settings_harvest::test_settings_harvest,
        commands::harvest::get_harvest_entries_for_day,
